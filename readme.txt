...
In addition, JobifyPlugin features:
...
For more information and developer usage, see <a href="https://benmarshall.me/jobifyPlugin" target="_blank">benmarshall.me/jobifyPlugin</a>.
...
1. Upload the `jobifyPlugin` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

== Frequently Asked Questions ==

See <a href="https://benmarshall.me/jobifyPlugin" target="_blank">benmarshall.me/jobifyPlugin</a>.

== Screenshots ==

1. JobifyPlugin creates a custom sidebar for your job posts
2. Add job listings to any widget area with the highly configurable JobifyPlugin widget
...
* Updated the <code>jobifyPlugin_addAPI</code> method
...
= 1.3.0 =
* Updated array sent to <code>jobifyPlugin_addAPI</code>
* Added the <code>[jobifyPlugin]</code> shortcode

= 1.2.0 =
* Updated readme file & assets

= 1.1.0 =
* Added <code>jobifyPlugin_addAPI</code> function to allow themes and plugins to add additional job APIs.
