<?php
class JobifyPlugin_Plugin implements ArrayAccess {
  protected $contents;
  ...
  public function plugin_action_links( $links ) {
    $link = array( '<a href="' . jobifyPlugin_admin_url() . '?page=jobifyPlugin">' . __( 'Settings', 'jobifyPlugin' ) . '</a>' );
  ...
  public function plugin_row_meta( $links, $file ) {
    if ( false !== strpos( $file, 'jobifyPlugin.php' ) ) {
      $links = array_merge( $links, array( '<a href="https://benmarshall.me/jobifyPlugin/">Documentation</a>' ) );
  ...
  public function run() {
    ...
    if ( is_plugin_active_for_network( plugin_basename( JobifyPlugin_PLUGIN ) ) ) {
      add_filter( 'network_admin_plugin_action_links_' . plugin_basename( JobifyPlugin_PLUGIN ), array( $this, 'plugin_action_links' ) );
    } else {
      add_filter( 'plugin_action_links_' . plugin_basename( JobifyPlugin_PLUGIN ), array( $this, 'plugin_action_links' ) );
    }
  }
  ...
  public function load_plugin_textdomain() {
    load_plugin_textdomain( 'jobifyPlugin', false, dirname( plugin_basename( JobifyPlugin_PLUGIN ) ) . '/languages' );
  }
}